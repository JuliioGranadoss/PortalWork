...
class BarcodeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', 'barcodes.action')
            ->escapeColumns([])
            ->setRowId('id');
    }
     ...
     *
     * @param \App\Models\Barcode $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Barcode $model, Request $request): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('code')->responsivePriority(1)->targets(0)->title('Código'),
