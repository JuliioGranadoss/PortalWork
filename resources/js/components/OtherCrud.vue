        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form @submit.prevent="checkBeforeSubmit" id="otherForm" name="otherForm" class="form-horizontal">
...
export default {
    ...
    methods: {
        submit() {
            let self = this;
            this.disable = true;
            axios.post('/others', this.model)
                .then(function (response) {
                    $('#otherForm').trigger("reset");
                    $('#ajaxOther').modal('hide');
                    self.$swal({
                        position: 'top-end',
                        icon: 'success',
        ...
        checkBeforeSubmit() {
            ...
            if (!this.model.name || !this.model.description || !this.model.score) {
        ...
        ajustTable() {
            $('#other-table').DataTable().columns.adjust().draw();
        }
    },
    mounted() {
        let self = this;
        ...
        $('body').on('click', '.editOther', function () {
            var id = $(this).data('id');
